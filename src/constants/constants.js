export const ADDIONAL_CATEGORIES1 = ["Only On Swiggy", "See All"];
export const ADDIONAL_CATEGORIES = [
  {
    title: 'Only On Swiggy',
    key: 'exclusive',
    description:'exclusive Restuarants'
  },
  {
    title: 'See All',
    key: 'all',
    description:'See All Restuarants'
  }
